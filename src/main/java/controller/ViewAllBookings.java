...
public class ViewAllBookings extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<BookingData> bookingHistory = b.getAllUserBookingHistory();
      
        System.out.println("Here at viewbooking");
        // Set the booking history in request scope
        if (bookingHistory == null) {
        	System.out.println("Here in viewbooking");
        ...
        // Forward to JSP page
        RequestDispatcher dispatcher = request.getRequestDispatcher("viewAllBooking.jsp");
